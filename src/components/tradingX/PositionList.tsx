    ...
    <div className={`space-y-6 ${className}`}>
      ...
      <div>
        ...
        {openPositions.length === 0 ? (
          <div className="bg-[#1a1a1a]/50 backdrop-blur-sm border border-white/10 rounded-xl p-6 text-center">
      ...
      {closedPositions.length > 0 && (
        <div>
          <h3 className="text-lg font-bold text-white mb-3">Position History</h3>
          ...
          {closedPositions.length > 4 && (
            <div className="mt-3 text-center">
              <button className="text-sm text-white/50 hover:text-white underline">
